                    ...
                    <div id="card`+tokenAddress+id+`" class="card shadow-sm">
                      <div class="top-row">
                        <div class="creator-photo">
                          <a id='owner`+tokenAddress+id+`' href="https://ty-sir.github.io/client/profile?address=`+owner+`"><img class="owner shadow-sm" id="ownerPhoto`+tokenAddress+id+`" src="" width="40" alt="owner photo">
...
function userCard(ethAddress){
  let userCard = `<li id="userItem`+ethAddress+`" class="list-group-item d-flex justify-content-between align-items-center">
                    <a href="https://ty-sir.github.io/client/profile?address=`+ethAddress+`">
